...
```
부서 목록(개발팀·인사팀·영업팀·재무관리팀 — 2026-07-27 정정: 예전엔 인사팀·기획팀·개발팀·
디자인팀·총무팀으로 적혀 있었으나, 2026-07-22 지출결의서 2차 승인자(재무관리팀) 후보를
추가하며 배포용 `schema/data.sql` 실제 시드 데이터 기준으로 부서 구성이 바뀜)을 저장합니다.
