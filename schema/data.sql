...
-- ------------------------------------
-- 5. REPOSITORY (자료실 카테고리) - 전사 공용 1개 + 부서별 1개씩
-- DEPT_ID가 NULL이면 전사 공용, 값이 있으면 그 부서 전용 자료실
-- (ERD_설계서.md 2-7: "지금은 부서마다 자료실이 1개씩")
-- ------------------------------------
INSERT INTO REPOSITORY (REPO_NAME, DEPT_ID) VALUES
  ('전사 공용 자료실', NULL),
  ('개발팀 자료실', 1),
  ('인사팀 자료실', 2),
  ('영업팀 자료실', 3);
